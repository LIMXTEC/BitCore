...
#ifndef BITCORE_GOVERNANCE_CLASSES_H
#define BITCORE_GOVERNANCE_CLASSES_H
...
public:
    ...
    static bool IsValid(const CTransactionRef txNew, int nBlockHeight, CAmount blockReward, CBlockHeader pblock);
};
...
public:
    ...
    static CAmount GetPaymentsLimit(int nBlockHeight, CBlockHeader pblock);
...
#endif // BITCORE_GOVERNANCE_CLASSES_H
