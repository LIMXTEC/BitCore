...
unsigned int CalculateNextWorkRequired(const CBlockIndex* pindexLast, int64_t nFirstBlockTime, const CBlockHeader *pblock, const Consensus::Params&); // For Setion test
