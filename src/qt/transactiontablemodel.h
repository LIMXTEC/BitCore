...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, BitCoreUnits::SeparatorStyle separators=BitCoreUnits::separatorStandard) const;
