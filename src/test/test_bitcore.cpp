...
#define BOOST_TEST_MODULE BitCore Test Suite

#include "test_bitcore.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_bitcore_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
