...
# Copyright 2016 The BitCore Core developers
...
help_text="""Test framework for bitcore utils.

Runs automatically during `make check`.

Can also be run manually from the src directory by specifying the source directory:

test/bitcore-util-test.py --srcdir='srcdir' [--verbose]
"""
...
if __name__ == '__main__':
    ...
    bctest.bctester(srcdir + "/test/data", "bitcore-util-test.json", buildenv)
