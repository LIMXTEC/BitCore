...
#ifndef BITCORE_MASTERNODE_H
#define BITCORE_MASTERNODE_H
...
static const int MASTERNODE_EXPIRATION_SECONDS          =   4 * 65 * 60;  //BTX 2024-10 We make it a little easier to keep the mn online. old 65 * 60; 
static const int MASTERNODE_WATCHDOG_MAX_SECONDS        = 120 * 60;
static const int MASTERNODE_NEW_START_REQUIRED_SECONDS  =   4 * 180 * 60;  // old 180 * 60;
