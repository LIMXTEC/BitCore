...
#ifndef BITCORE_INTERFACES_NODE_H
#define BITCORE_INTERFACES_NODE_H
...
public:
    ...
    // Dash
    //! Register handler for additional data sync progress messages.
...
#endif // BITCORE_INTERFACES_NODE_H
