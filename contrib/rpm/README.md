...
[Bitcoin git repository](https://github.com/bitcore/bitcore) but are not part of
...
in the bitcore git repository. At present only an SVG version of the Bitcoin
icon is used.
