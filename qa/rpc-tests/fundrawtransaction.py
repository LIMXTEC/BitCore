...
class RawTransactionsTest(BitCoreTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid bitcore address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid bitcore address" in e.error['message'])
