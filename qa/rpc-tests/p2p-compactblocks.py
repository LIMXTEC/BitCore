...
from test_framework.test_framework import BitCoreTestFramework
...
# TestNode: A peer we use to send messages to bitcored, and store responses.
...
class CompactBlocksTest(BitCoreTestFramework):
    def __init__(self):
        super().__init__()
    ...
    # This test actually causes bitcored to (reasonably!) disconnect us, so do this last.
    ...
    # Test that bitcored requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for bitcored to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # bitcored will not send blocktxn responses for blocks whose height is
