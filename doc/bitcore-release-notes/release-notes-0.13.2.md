BitCore Core version 0.13.2 is now available from:

  <https://download.bitcore.org/bitcore-0.13.2.1/>
...
(https://github.com/bitcore/bips/blob/master/bip-0130.mediawiki)
...
BitCore Core 0.13.2 will have a strict maximum size on the mempool. The
...
BitCore Core 0.13.2 also introduces new default policy limits on the length and
...
This allows running bitcored without having to do any manual configuration.
...
`bitcore.conf`, where `N` is the number of MiB to allot for
raw block & undo data.
...
notes of BitCore Core v0.11.0](https://github.com/bitcore-project/bitcore-core/blob/v0.11.0/doc/release-notes.md#block-file-pruning).

`NODE_BLOOM` service bit
------------------------

Support for the `NODE_BLOOM` service bit, as described in [BIP
111](https://github.com/bitcore/bips/blob/master/bip-0111.mediawiki), has been
...
* OP_NOP2 has been renamed to OP_CHECKLOCKTIMEVERIFY by [BIP 65](https://github.com/bitcore/bips/blob/master/bip-0065.mediawiki)
...
Then, to tunnel a SSL connection on 240332 to a RPC server bound on localhost on port 19334 do:

    stunnel -d 240332 -r 127.0.0.1:19334 -p stunnel.pem -P ''
...
caching. A sample config for apache2 could look like:
    ...
    <Location /bitcorerpc>
        ...
        # optional bypass bitcored rpc basic auth
        # RequestHeader set Authorization "Basic <hash>"
        # get the <hash> from the shell with: base64 <<< bitcorerpc:<password>
    </Location>
...
Restarting bitcored will no longer clear out the list of banned peers; instead
...
- Adding `dbcache=100` in bitcore.conf
...
For example:
    ...
    $ src/bitcore-cli -stdin walletpassphrase
    mysecretcode
    120
...
- `bitcore-${VERSION}-arm-linux-gnueabihf.tar.gz`: Linux binaries for the most
  common 32-bit ARM architecture.
- `bitcore-${VERSION}-aarch64-linux-gnu.tar.gz`: Linux binaries for the most
...
<https://github.com/bitcore-project/bitcore-core/pull/7184>

BIP112 soft fork to enforce OP_CHECKSEQUENCEVERIFY
--------------------------------------------------

[BIP112][] redefines the existing OP_NOP3 as OP_CHECKSEQUENCEVERIFY (CSV)
for a new opcode in the BitCore scripting system that in combination with
[BIP68][] allows execution pathways of a script to be restricted based
on the age of the output being spent.

For more information about the implementation, see
<https://github.com/bitcore-project/bitcore-core/pull/7524>
...
For more information about the implementation, see
<https://github.com/bitcore-project/bitcore-core/pull/6566>
...
compatible peers.
[BIP 152](https://github.com/bitcore/bips/blob/master/bip-0152.mediawiki)
...
Witness)] (https://github.com/bitcore/bips/blob/master/bip-0141.mediawiki).
...
(https://github.com/bitcore/bips/blob/master/bip-0141.mediawiki) for additional
details.)
...
- The optional new p2p message "feefilter" is implemented and the protocol
  ...
  feerate. [BIP 133](https://github.com/bitcore/bips/blob/master/bip-0133.mediawiki)
...
65](https://github.com/bitcore/bips/blob/master/bip-0065.mediawiki)

  - OP_NOP3 has been renamed to OP_CHECKSEQUENCEVERIFY by [BIP
112](https://github.com/bitcore/bips/blob/master/bip-0112.mediawiki)
...
- **Elimination of unwanted transaction malleability:** Segregating the witness
  ...
  malleability, which is a problem that makes programming BitCore wallet
  software more difficult and which seriously complicates the design of smart
  contracts for BitCore.
...
- **Weighting data based on how it affects node performance:** Some parts of
  each BitCore block need to be stored by nodes in order to validate future
...
- **Signature covers value:** A simple improvement in the way signatures are
  ...
  of bitcores they think they are spending, and by having full nodes refuse to
  accept those signatures unless the amount of bitcores being spent is exactly
...
- **Increased security for multisig:** BitCore addresses (both P2PKH addresses
  ...
  believed to be provided by BitCore's choice of parameters for its Elliptic
  Curve Digital Security Algorithm [ECDSA].)

- **More efficient almost-full-node security** Satoshi Nakamoto's original
  BitCore paper describes a method for allowing newly-started full nodes to
  skip downloading and validating some data from historic blocks that are
  protected by large amounts of proof of work.  Unfortunately, Nakamoto's
  method can't guarantee that a newly-started node using this method will
  produce an accurate copy of BitCore's current ledger (called the UTXO set),
  ...
  note that BitCore Core does not provide an option to use this capability as
  of this 0.13.2 release.

- **Script versioning:** Segwit makes it easy for future soft forks to allow
  BitCore users to individually opt-in to almost any change in the BitCore
  Script language when those users receive new transactions.  Features
  currently being researched by BitCore and BitCore Core contributors that may
  ...
  Other BitCore community members are studying several other improvements
...
segwit's start date of 1 January 2017 miners can update the BitCore
client to BitCore Core 0.13.2 to signal for segwit support. When a
...
[Segwit FAQ]: https://bitcorecore.org/en/2016/01/26/segwit-benefits/
[segwit wallet developers guide]: https://bitcorecore.org/en/segwit_wallet_dev/
[BIP141]: https://github.com/bitcore/bips/blob/master/bip-0141.mediawiki
[BIP143]: https://github.com/bitcore/bips/blob/master/bip-0143.mediawiki
[BIP144]: https://github.com/bitcore/bips/blob/master/bip-0144.mediawiki
[BIP145]: https://github.com/bitcore/bips/blob/master/bip-0145.mediawiki
...
Since BitCore Core 0.10.0, nodes have defaulted to only relaying and
...
[BIP147]: https://github.com/bitcore/bips/blob/master/bip-0147.mediawiki
...
- `bitcore-${VERSION}-arm-linux-gnueabihf.tar.gz`: Linux binaries targeting
  the 32-bit ARMv7-A architecture.
- `bitcore-${VERSION}-aarch64-linux-gnu.tar.gz`: Linux binaries targeting
...
- [The BitCore Core Developers](/doc/release-notes)
- Charles Lee
- Adrian Gallagher
- shaolinfry
- Xinxi Wang
