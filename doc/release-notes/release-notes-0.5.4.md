BitCore version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bitcore/files/BitCore/bitcore-0.5.4/
...
http://gitorious.org/bitcore/bitcored-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix BitCore-Qt notifications under Growl 1.3.
Increase required age of BitCore-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBitCore properly when installing BitCore-Qt over it. (Windows)
