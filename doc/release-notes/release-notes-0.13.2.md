BitCore Core version 0.13.2 is now available from:
  ...
  <https://bitcore.org/bin/bitcore-core-0.13.2/>
...
- #8908 `4a974b2` Update bitcore-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow bitcore-tx to create v2 transactions (btcdrak)
