Download URL: https://sourceforge.net/projects/bitcore/files/Bitcoin/bitcore-0.3.22/
...
* IRC is overflowing.  Client now bootstraps to channels #bitcore00 - #bitcore99
