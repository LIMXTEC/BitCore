BitCore Core version 0.13.1 is now available from:

  <https://bitcore.org/bin/bitcore-core-0.13.1/>
...
- **Script versioning:** Segwit makes it easy for future soft forks to allow
  ...
  currently being researched by BitCore Core contributors that may use this
...
[versionbits FAQ]: https://bitcorecore.org/en/2016/06/08/version-bits-miners-faq/
...
- #8848 `7a34a46` Add NULLDUMMY verify flag in bitcoreconsensus.h (jl2012)
...
- #8940 `5b4192b` Add x9 service bit support to dnsseed.bluematt.me, seed.bitcorestats.com (TheBlueMatt, cdecker)
- #8944 `685e4c7` Remove bogus assert on number of oubound connections. (TheBlueMatt)
- #8949 `0dbc48a` Be more agressive in getting connections to peers with relevant services (gmaxwell)

### Build system
- #8293 `fa5b249` Allow building libbitcoreconsensus without any univalue (luke-jr)
- #8492 `8b0bdd3` Allow building bench_bitcore by itself (luke-jr)
...
- #8829 `2a8bca4` Add bitcore-tx JSON tests (jnewbery)
- #8834 `1dd1783` blockstore: Switch to dumb dbm (MarcoFalke)
- #8835 `d87227d` nulldummy.py: Don't run unused code (MarcoFalke)
- #8836 `eb18cc1` bitcore-util-test.py should fail if the output file is empty (jnewbery)
...
- #8860 `0bee740` util: Move wait_bitcoreds() into stop_nodes() (MarcoFalke)
...
- #8683 `8a7d7ff` Fix incorrect file name bitcore.qrc  (bitcoresSG)
...
- #8817 `bcf3806` update bitcore-tx to output witness data (jnewbery)
