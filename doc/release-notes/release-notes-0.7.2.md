BitCore version 0.7.2 is now available from:
  http://sourceforge.net/projects/bitcore/files/BitCore/bitcore-0.7.2
...
* Fix use-after-free problems in initialization and shutdown, the latter of
  which caused BitCore-Qt to crash on Windows when exiting.
