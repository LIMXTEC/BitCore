Bitcoin Core version 0.13.0 is now available from:
  ...
  <https://bitcore.org/bin/bitcore-core-0.13.0/>
...
141](https://github.com/bitcore/bips/blob/master/bip-0141.mediawiki), [BIP
143](https://github.com/bitcore/bips/blob/master/bip-0143.mediawiki), [BIP
144](https://github.com/bitcore/bips/blob/master/bip-0144.mediawiki), and [BIP
145](https://github.com/bitcore/bips/blob/master/bip-0145.mediawiki) are
...
- #7550 `8b958ab` Input-from-stdin mode for bitcore-cli (laanwj)
...
- #7613 `3798e5d` Add autocomplete to bitcore-qt's console window (GamerSg)
...
- #7636 `fb0ac48` Add bitcore address label to request payment QR code (makevoid)
- #8231 `760a6c7` Fix a bug where the SplashScreen will not be hidden during startup (jonasschnelli)
- #8256 `af2421c` BUG: bitcore-qt crash (fsb4000)
...
- #8047 `37f9a1f` Test_framework: Set wait-timeout for bitcored procs (MarcoFalke)
...
- #7744 `d8e862a` test_framework: detect failure of bitcored startup (laanwj)
...
- #7975 `fc23fee` Update bitcore-core GitHub links (MarcoFalke)
