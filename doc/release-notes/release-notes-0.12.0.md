...
(https://github.com/bitcore/bips/blob/master/bip-0125.mediawiki).
...
- #6600 `ef4945f` Include bitcore-tx binary on Debian/Ubuntu (Zak Wilcox)
...
- #6390 `6a73d66` tests: Fix bitcore-tx signing test case (Wladimir J. van der Laan)
...
- #6730 `cb4d6d0` build: Remove dependency of bitcore-cli on secp256k1 (Wladimir J. van der Laan)
...
- #7209 `f3ad812` test: don't override BITCORED and BITCORECLI if they're set (Wladimir J. van der Laan)
...
- #6430 `b01981e` doc: add documentation for shared library libbitcoreconsensus (Braydon Fuller)
