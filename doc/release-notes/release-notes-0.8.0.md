BitCore-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/bitcore/files/BitCore/bitcore-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the BitCore
...
New/changed settings (command-line or bitcore.conf file)
--------------------------------------------------------
