BitCore Core version 0.10.3 is now available from:

  <https://bitcore.org/bin/bitcore-core-0.10.3/>
...
(see https://github.com/bitcore-project/bitcore-core/pull/6793, as well as the 0.11.0
